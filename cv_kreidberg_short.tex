...
\begin{list}{}{\cvlist}
    \item Science Organizing Committee for multiple conferences, 
            \begin{sloppypar}
            including Exoplanets III and IV, Exoclimes, Sagan Summer Workshop \hfill 2018 - present
            \end{sloppypar}
    \item Member, HST-JWST Strategy Committee (constituted by the STScI director) \hfill 2023 
...
\item Past advisor to four graduate students on independent research projects (Hannah Diamond-Lowe, Tom Louden, George McDonald, and Lily Zhao) and one postdoc (Jason Dittmann)
\end{list}
